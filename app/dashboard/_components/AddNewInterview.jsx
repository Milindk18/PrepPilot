...
function AddNewInterview() {
    ...
    const onSubmit = async (e) => {
        ...
        const InputPrompt = `Job Position: ${jobPosition}, Job Description: ${jobDesc}, Years of Experience: ${jobExperience}. As per this information, please provide me ${process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT} interview questions with answers in JSON format. Provide questions and answers as fields in JSON.`;
        ...
        try {
            ...
            try {
                ...
                console.error("Failed to parse cleaned JSON response:", jsonError);
            }
        } catch (error) {
            console.error("Failed to fetch or process response:", error);
        }
